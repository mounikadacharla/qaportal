...
export class QuestionsService{
  question;
  private _url: string="http://localhost:8080/QAPORTAL-1.0-SNAPSHOT/home";
  private _urlForAnswers: string = "http://localhost:8080/QAPORTAL-1.0-SNAPSHOT/questionid";
  private _urlForAnswering:string= "http://localhost:8080/QAPORTAL-1.0-SNAPSHOT/answertoquestion";
 ...
 onSubmitAnswer(value,questionId){
    let postData={
