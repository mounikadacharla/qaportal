...
public class SampleVO {
	...
	@Override
	public int hashCode() {
		return Objects.hash(addressLine1, addressLine2, addressCity,
				addressState, addressCountry, addressZip1, addressZip2);
	}
	...
	public String toString() {
		...
		sb.append("    addressLine2: ").append(toIndentedString(addressLine2))
				.append("\n");
		sb.append("    addressCity: ").append(toIndentedString(addressCity))
				.append("\n");
		sb.append("    addressState: ").append(toIndentedString(addressState))
				.append("\n");
		sb.append("    addressCountry: ")
				.append(toIndentedString(addressCountry)).append("\n");
		sb.append("    addressZip1: ").append(toIndentedString(addressZip1))
				.append("\n");
		sb.append("    addressZip2: ").append(toIndentedString(addressZip2))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
